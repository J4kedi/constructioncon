      ...
      <div className="rounded-md bg-background p-4 md:p-6 space-y-4">
        ...
        <div>
          ...
          <input
            ...
            className="block w-full rounded-md border border-secondary/20 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-50 py-2 px-3 text-sm placeholder:text-gray-500"
          />
        </div>

        <div>
          <label htmlFor="endCustomerId" className="mb-2 block text-sm font-medium text-text">
        ...
        <div className="flex gap-4">
          <div className="flex-1">
            ...
            <input
              ...
              name="dataInicio"
              type="date"
              className="block w-full rounded-md border border-secondary/20 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-50 py-2 px-3 text-sm"
            />
          </div>
          <div className="flex-1">
